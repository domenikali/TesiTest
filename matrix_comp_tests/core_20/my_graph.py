...
if __name__ == "__main__":
    ...
    print("mtd_4: ", np.average(mtd_4))
    print("mtd_8: ", np.average(mtd_8))
    print("mtd_16: ", np.average(mtd_16))
    print("mtd_20: ", np.average(mtd_20))
    print("mtd_32: ", np.average(mtd_32))
    print("mtd_512: ", np.average(mtd_512))
